...
public class Warrior extends Job {
	...
	public void createSkillTree() {
		...
		forceAmelio3.setDependance(new boolean[] { forceAmelio1.isBought(),
				forceAmelio2.isBought() });
		forceAmelio4.setDependance(new boolean[] { forceAmelio1.isBought(),
				forceAmelio2.isBought(), forceAmelio3.isBought() });

		jobSkills = new Skill[] { forceAmelio1, forceAmelio2, forceAmelio3,
				forceAmelio4 };
	}
	...
	public class ForceAmelio1 extends Skill {
		...
		public ForceAmelio1() {
			super("Force +1", "augmente la force de 1", 100,
					skillType.amelioration);
		}
	...
	public class ForceAmelio2 extends Skill {
		public ForceAmelio2() {
			super("Force +2", "augmente la force de 2", 100,
					skillType.amelioration);
		}
	...
	public class ForceAmelio3 extends Skill {
		public ForceAmelio3() {
			super("Force +5", "augmente la force de 5", 100,
					skillType.amelioration);
		}
	...
	public class ForceAmelio4 extends Skill {
		public ForceAmelio4() {
			super("Force +12", "augmente la force de 12", 100,
					skillType.amelioration);
		}
	...
	public class LifeAmelio1 extends Skill {
		public LifeAmelio1() {
			super("HP +30", "augmente la vie de 30", 100,
					skillType.amelioration);
		}
	...
	public class LifeAmelio2 extends Skill {
		public LifeAmelio2() {
			super("HP +70", "augmente la vie de 70", 100,
					skillType.amelioration);
		}
	...
	public class LifeAmelio3 extends Skill {
		public LifeAmelio3() {
			super("HP +200", "augmente la vie de 200", 100,
					skillType.amelioration);
		}
	...
	public class LifeAmelio4 extends Skill {
		public LifeAmelio4() {
			super("HP +300", "augmente la vie de 300", 100,
					skillType.amelioration);
		}
	...
	public class Dash extends Skill {
		public Dash() {
			super("Dash", "permet de Dash et de pousser son adversaire", 200,
					skillType.capacity);
		}
	...
	public class CriticalStrike extends Skill {
		public CriticalStrike() {
			super("Critical Strike", "10% de chance de coup critique", 250,
					skillType.capacity);
		}
